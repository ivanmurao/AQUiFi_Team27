...
import raspi from "@assets/images/prototype-components/raspberry-pi.png";
import valve from "@assets/images/prototype-components/valve.png";
import mobile from "@assets/images/prototype-components/mobile-phone.png";
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalInfoText}>
                Arduino UNO is an open-source, and programmable microcontroller
                board that is flexible and easy to use, making it suitable for a
                wide range of electronic projects.{"\n\n"}
                It is an essential component in the system as it will be used to
                connect the analog sensors into the Raspberry Pi.
              </Text>
              <Button
                title="Close"
                color={"#255C99"}
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.horizontalLine} />
              <Text style={styles.modalInfoText}>
                Raspberry Pi is a tiny computer with the size of a credit card,
                which can transform any monitor, TV, mouse, or keyboard into a
                full-featured PC. This component will stand as the singular and
                central processing unit, effectively overseeing both sensor
                interfacing and data processing tasks.{"\n\n"}
                Raspberry Pi, with its enhanced computational capabilities,
                takes on the responsibility of collecting real-time data from
                sensors measuring turbidity, and pH. Subsequently, it processes
                this data using a deep learning algorithm, comparing it against
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.horizontalLine} />
              <Text style={styles.modalInfoText}>
                Turbidity Sensor is an essential part of the system that
                determines how hazy or cloudy the water is.{"\n\n"}
                Tubidity sensor is detecting the presence of impurities. It is
                measured in Nephelometric Turbidity Units (NTU), and lower
                values, generally less than 1 NTU, are preferred for potable
                water, as higher turbidity can indicate contamination or water
                quality issues.
              </Text>
              <Button
                title="Close"
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.horizontalLine} />
              <Text style={styles.modalInfoText}>
                pH Sensor is used for measuring the acidity or alkalinity of
                water based on its pH level. It is essential for identifying the
                water's chemical characteristics and making sure it is both safe
                and pleasant to drink.{"\n\n"}
                Water's pH normally ranges from 0 (very acidic) to 14 (very
                alkaline), with a neutral pH of 7 being ideal for drinking
                water. If the pH is not between 6.5 and 8.5, there may be
                possible problems with the quality of the water.
              </Text>
              <Button title="Close" color={"#255C99"} onPress={togglepHModal} />
            </View>
          </View>
        </Modal>
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.horizontalLine} />
              <Text style={styles.modalInfoText}>
                Solenoid Valves are control devices that can either open or
                close a fluid flow when electrically activated or deactivated.
                {"\n\n"}
                It is a crucial component in water quality management as it will
                control the flow of water when the sensors detect an anomaly.
                Specifically, the system is designed by default to open the
                solenoid valve. When the measured water parameters isn't within
                the standard maximum allowable range, the solenoid valve will
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.horizontalLine} />
              <Text style={styles.modalInfoText}>
                Mobile Application is used to provide users with detailed
                monitoring for the quality of drinking water. It is developed
                using React Native Framework for its scalability and
                flexibility.{"\n\n"}
                The main purpose of the Mobile App here is to display the output
                of the detected parameters as well as display their predicted
                values. In addition to this, the mobile app can also be used to
                remotely control the solenoid valve.
              </Text>
              <Button
                title="Close"
                color={"#255C99"}
